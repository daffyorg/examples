...
struct Mocks {
    struct Boston {
        ...
        static var mockDonationRecommendations: [DonationRecommendation] = [DonationRecommendation(
            description:
            """
    ...
    struct SaltLakeCity {
        ...
        static var mockDonationRecommendations: [DonationRecommendation] = [DonationRecommendation(description: "Donate to the Salt Lake City Homeless Shelter to provide essential support, shelter, and resources to those experiencing homelessness. Your contribution helps meet basic needs, promote health and wellness, offer employment and housing assistance, foster community support, and break the cycle of homelessness. Make a lasting impact today.", nonProfit: mockNonProfit, donationAmounts: [20, 40, 60])]
        static var mockNewsArticle1 = NewsArticle(
